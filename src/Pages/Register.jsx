...
const Register = ({
  name,
  setName,
  fullname, // Add fullName state variable
  setFullname,
  email,
  setEmail,
  password,
  ...
  const handleRegister = (event) => {
    ...
    const userData = { fullname, name, email, password }; // Include fullName
    ...
    setFullname(""); // Clear the fullName field
    setName("");
    setEmail("");
    setPassword("");
    setAgree(false);
  ...
  return (
    <div className=" w-full lg:h-screen flex items-center justify-center ">
      <div className=" xl:w-[50%] xl:h-[600px] lg:w-[80%] lg:h-[600px] w-full  bg-white shadow xl:flex lg:flex flex-row-reverse items-center xl:rounded-lg lg:rounded-lg overflow-hidden">
        <div className="flex-1 xl:h-full lg:h-full relative h-[500px] md:h-[50vh]  xl:w-[50%] ">
          ...
          <div className="absolute w-full h-full background p-6 flex flex-col md:p-10 justify-center">
            ...
            <Link to="/login" className="w-[200px] ">
        ...
        <div className="flex-1 h-full xl:w-[50%] bg-slate-50 md:h-[50vh] ">
          <div className="w-full h-full  p-6 flex flex-col items-center justify-center">
            <Card
              ...
              <form className="mt-8 xl:w-full lg:w-full mb-2 max-w-screen-lg sm:w-[500px] w-[300px]">
                <div className="mb-4 flex flex-col gap-6">
                  ...
                  <Input
                    size="lg"
                    variant="static"
                    value={fullname} // Use fullName state variable
                    onChange={(e) => setFullname(e.target.value)} // Use setFullName setter function
                    label="Full Name"
                    className="xl:w-full"
                  />
                  <Input
